...
│  │     ├─ replay.page.css
│  │     ├─ manifest.page.css
│  │     └─ whitepaper.page.css   # 同理：每个页面只写“本页差异”，禁止重写 core 组件
│  │
│  └─ js/
...
│     └─ runtime/
│        ├─ index.runtime.js       # 页面运行时：index 专属逻辑（比如跳转/按钮绑定）
│        ├─ cases.runtime.js       # 页面运行时：cases 页的卡片跳转/筛选等
│        └─ replay.runtime.js      # 页面运行时：replay 页 fetch registry + 播放/渲染
│
├─ assets/data/
│  ├─ narratives/
